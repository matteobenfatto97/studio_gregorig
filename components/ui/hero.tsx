...
type Section = {
  ...
  igiene?: string;
  medicina?: string;
  paradontologia?: string;
  buttonText?: string;
  buttonLink?: Route; // 👈 route tipizzata
  buttonPosition?: CSSProperties;
  icon1Position?: CSSProperties;
  icon2Position?: CSSProperties;
  className?: string;
...
const sections: Section[] = [
  {
    ...
    buttonText: "Prenota!",
    buttonLink: "/servizi" as Route, // 👈 tipizzata
  ...
  },
  {
    ...
    icon1Position: { top: "30%", left: "0%" },
    icon2Position: { top: "40%", left: "15%" },
    // niente buttonText/buttonLink qui
  },
  {
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start ml-8 justify-center h-full text-white">
        ...
        {buttonText && buttonLink && (
          <Link
            href={buttonLink} // 👈 ora è Route, non più string
